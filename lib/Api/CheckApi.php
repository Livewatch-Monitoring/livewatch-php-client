...
class CheckApi
{
    ...
    /**
     * Operation allCheckNotifications
     *
     ...
     * @return \LivewatchApi\Model\CheckNotification
     */
    public function allCheckNotifications()
    {
        list($response) = $this->allCheckNotificationsWithHttpInfo();
        return $response;
    }

    /**
     * Operation allCheckNotificationsWithHttpInfo
     *
     * Get notifications of all checks
     *
     *
     * @throws \LivewatchApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LivewatchApi\Model\CheckNotification, HTTP status code, HTTP response headers (array of strings)
     */
    public function allCheckNotificationsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LivewatchApi\Model\CheckNotification' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LivewatchApi\Model\CheckNotification', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LivewatchApi\Model\CheckNotification',
    ...
    /**
     * Operation allCheckNotificationsAsync
     *
     * Get notifications of all checks
     *
     *
     ...
     */
    public function allCheckNotificationsAsync()
    {
        return $this->allCheckNotificationsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation allCheckNotificationsAsyncWithHttpInfo
     *
     * Get notifications of all checks
     *
     *
    ...
    /**
     * Create request for operation 'allCheckNotifications'
     *
     *
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation checkEventsByDate
     *
     * Get events of one check by date
     *
     * @param  string $date Date to get events for (required)
     * @param  string $uuid uuid (required)
     *
     * @throws \LivewatchApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LivewatchApi\Model\CheckEvent[]
     */
    public function checkEventsByDate($date, $uuid)
    {
        list($response) = $this->checkEventsByDateWithHttpInfo($date, $uuid);
        return $response;
    }

    /**
     * Operation checkEventsByDateWithHttpInfo
     *
     * Get events of one check by date
     *
     * @param  string $date Date to get events for (required)
     ...
     * @throws \LivewatchApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LivewatchApi\Model\CheckEvent[], HTTP status code, HTTP response headers (array of strings)
     */
    public function checkEventsByDateWithHttpInfo($date, $uuid)
    {
        $request = $this->checkEventsByDateRequest($date, $uuid);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LivewatchApi\Model\CheckEvent[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LivewatchApi\Model\CheckEvent[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\LivewatchApi\Model\CheckEvent[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation checkEventsByDateAsync
     *
     * Get events of one check by date
     *
     * @param  string $date Date to get events for (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkEventsByDateAsync($date, $uuid)
    {
        return $this->checkEventsByDateAsyncWithHttpInfo($date, $uuid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation checkEventsByDateAsyncWithHttpInfo
     *
     * Get events of one check by date
     *
     * @param  string $date Date to get events for (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkEventsByDateAsyncWithHttpInfo($date, $uuid)
    {
        $returnType = '\LivewatchApi\Model\CheckEvent[]';
        $request = $this->checkEventsByDateRequest($date, $uuid);
    ...
    /**
     * Create request for operation 'checkEventsByDate'
     *
     * @param  string $date Date to get events for (required)
     * @param  string $uuid (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function checkEventsByDateRequest($date, $uuid)
    {
        // verify the required parameter 'date' is set
        if ($date === null || (is_array($date) && count($date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $date when calling checkEventsByDate'
            );
        }
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $uuid when calling checkEventsByDate'
            );
        }

        $resourcePath = '/api/check/check/events/{uuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \LivewatchApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LivewatchApi\Model\CheckHistory
     */
    public function checkHistory($uuid)
    {
        list($response) = $this->checkHistoryWithHttpInfo($uuid);
        return $response;
    }

    /**
     * Operation checkHistoryWithHttpInfo
     *
     * Get history of one check
     *
     * @param  string $uuid (required)
     ...
     * @throws \LivewatchApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LivewatchApi\Model\CheckHistory, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkHistoryWithHttpInfo($uuid)
    {
        $request = $this->checkHistoryRequest($uuid);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LivewatchApi\Model\CheckHistory' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LivewatchApi\Model\CheckHistory', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\LivewatchApi\Model\CheckHistory';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LivewatchApi\Model\CheckHistory',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkHistoryAsync($uuid)
    {
        return $this->checkHistoryAsyncWithHttpInfo($uuid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation checkHistoryAsyncWithHttpInfo
     *
     * Get history of one check
     *
     * @param  string $uuid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkHistoryAsyncWithHttpInfo($uuid)
    {
        $returnType = '\LivewatchApi\Model\CheckHistory';
        $request = $this->checkHistoryRequest($uuid);
    ...
    /**
     * Create request for operation 'checkHistory'
     *
     * @param  string $uuid (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function checkHistoryRequest($uuid)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $uuid when calling checkHistory'
            );
        }

        $resourcePath = '/api/check/latest/{uuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \LivewatchApi\Model\CheckNotification
     */
    public function checkNotifications($uuid)
    {
        list($response) = $this->checkNotificationsWithHttpInfo($uuid);
        return $response;
    }

    /**
     * Operation checkNotificationsWithHttpInfo
     *
     * Get notifications of one check
     *
     * @param  string $uuid (required)
     ...
     * @return array of \LivewatchApi\Model\CheckNotification, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkNotificationsWithHttpInfo($uuid)
    {
        $request = $this->checkNotificationsRequest($uuid);
    ...
    /**
     * Operation checkNotificationsAsync
     *
     * Get notifications of one check
     *
     * @param  string $uuid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkNotificationsAsync($uuid)
    {
        return $this->checkNotificationsAsyncWithHttpInfo($uuid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation checkNotificationsAsyncWithHttpInfo
     *
     * Get notifications of one check
     *
     * @param  string $uuid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkNotificationsAsyncWithHttpInfo($uuid)
    {
        $returnType = '\LivewatchApi\Model\CheckNotification';
        $request = $this->checkNotificationsRequest($uuid);
    ...
    /**
     * Create request for operation 'checkNotifications'
     *
     * @param  string $uuid (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function checkNotificationsRequest($uuid)
    {
        // verify the required parameter 'uuid' is set
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $uuid when calling checkNotifications'
            );
        }

        $resourcePath = '/api/check/notifications/{uuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
